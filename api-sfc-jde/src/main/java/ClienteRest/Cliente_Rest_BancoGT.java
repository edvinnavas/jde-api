...
public class Cliente_Rest_BancoGT implements Serializable {

    private static final long serialVersionUID = 1L;

    public Cliente_Rest_BancoGT() {

    }

    public String Tipo_Cambio_Rango(String xml_request) {
        String xml_response = "";

        try {
            // System.out.println("XML_REQUEST: " + xml_request);
            HttpPost http_request = new HttpPost("https://www.banguat.gob.gt/variables/ws/TipoCambio.asmx?WSDL");
            http_request.setHeader("Accept-Encoding", "gzip,deflate");
            http_request.setHeader("Content-Type", "text/xml;charset=UTF-8;");
            http_request.setHeader("SOAPAction", "\"http://www.banguat.gob.gt/variables/ws/TipoCambioRango\"");
            http_request.setHeader("Host", "www.banguat.gob.gt");
            ...
            System.out.println("PROYECTO:api-sfc-jde|CLASE:" + this.getClass().getName() + "|METODO:Tipo_Cambio_Rango()|ERROR:" + ex.toString());
            xml_response = "PROYECTO:api-sfc-jde|CLASE:" + this.getClass().getName() + "|METODO:Tipo_Cambio_Rango()|ERROR:" + ex.toString();
        }
